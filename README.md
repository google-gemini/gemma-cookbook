...
| [Using_Gemma_with_mistral_rs.ipynb](Gemma/Using_Gemma_with_mistral_rs.ipynb)                                         | Run Gemma models using [mistral.rs](https://github.com/EricLBuehler/mistral.rs/).                                                                                                       |
...
| [Using_Gemma_with_LLM_Comparator.ipynb](Gemma/Using_Gemma_with_LLM_Comparator.ipynb)                                         | Compare Gemma with another LLM using [LLM Comparator](https://github.com/pair-code/llm-comparator/).                                                                                                           |
...
| [Gemma_Gradio_Chatbot.ipynb](Gemma/Gemma_Gradio_Chatbot.ipynb)                                                       | Building a Chatbot with Gemma and Gradio                                                                                                                                                |
| [Synthetic_data_generation_with_Gemma_2.ipynb](Gemma/Synthetic_data_generation_with_Gemma_2.ipynb)                   | Synthetic data generation with Gemma 2                                                                                                                                                  |
| **Prompting**                                                                                                        |                                                                                                                                                                                         |
...
| [Finetune_with_CALM.ipynb](Gemma/Finetune_with_CALM.ipynb)                                                           | Finetune Gemma using [CALM](https://github.com/google-deepmind/calm).                                                                                                                   |
